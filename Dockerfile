FROM apiology/rubymegamix:latest as systemd-builder
# ghcr.io/seqsense/datadog-agent:7-alpine
# https://github.com/seqsense/datadog-agent-alpine/blob/master/Dockerfile
...
COPY precache/disable-execinfo-for-musl.patch .
...
# ===========================
FROM apiology/rubymegamix:latest AS datadog-agent
